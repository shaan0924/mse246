...
periods <- 25 #CAN ONLY TAKE ON THE VALUE OF 5 OR 25
...
for (i in 1:periods) {
  ...
  raw_data_list[[i]] <- 
    raw_data_list[[i]][c("LogGrossApproval", "BinaryThirdPartyDollars", "TermInMonths", "LogGDP", "LogSP500", "LogFedFunds", "LogCPI", "URinProjectState", "URinBorrState", "BusinessType", "NAICS_Sector", "DeliveryMethod", "BinaryIntergerTerm", "BinaryRepeatBorrower", "BinaryBankStEqualBorrowerSt", "BinaryProjectStEqualBorrowerSt", "ApprovalFiscalYear", "BorrState", "ProjectState")]
